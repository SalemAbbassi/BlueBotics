report 50214 "BBX Purchase Quote"
{
    WordLayout = './BlueBotics Purchase Quote.docx';
    Caption = 'BlueBotics Purchase Quote';
    DefaultLayout = Word;
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            RequestFilterHeading = 'BlueBotics Purchase Quote';
            column(No_PurchHeader; "No.")
            {
            }
            column(QuotationText; QuotationText)
            {
            }
    ...
    var
        ...
        QuotationText: TextConst ENU = 'We would like you to provide a quotation for the following articles. Please provide the price for the defined quantities as well as the lead time. Many thanks in advance.';
