report 50206 "BBX Sales invoice"
{
    WordLayout = './BlueBotics Sales invoice.docx';
    Caption = 'BlueBotics Sales invoice';
    DefaultLayout = Word;
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            column(YourRegistrationCaption; YourRegistrationCaptionLbl)
            {
            }
            column(YourRegistration; RecGCustomer."VAT Registration No.")
            {
            }
            ...
            column(CompanyIBAN_Lbl; StrSubstNo('%1:', CompanyInfo.FieldCaption(IBAN)))
            {
            }
            column(CompanySWIFT; CompanyInfo."SWIFT Code")
            {
            }
            column(CompanySWIFT_Lbl; StrSubstNo('%1:', CompanyInfo.FieldCaption("SWIFT Code")))
            {
            }
            ...
            column(YourReference_Lbl; StrSubstNo('%1:', YourReferenceCaptionLbl))
            {
            }
            ...
            column(PostingDate_Lbl; StrSubstNo('%1:', DocumentDateLbl))
            {
            }
            ...
            //DBE
            column(OuReference_Lbl; StrSubstNo('%1:', OurReferenceCaptionLbl))
            {
            }
            column(OurReference; RecGSalesShptHeader."USer Id")
            {
            ...
            Column(Bill_to_Contact_Lbl; StrSubstNo('%1:', YourContactReferenceCaptionLbl))
            {
            }
            column(InvoiceoAddr_Lbl; InvoiceoAddrLbl)
            {
            }

            column(Order_Date; Format("Order Date", 0))
            {

            }
            column(OrderDate_Lbl; StrSubstNo('%1:', OrderDateLbl))
            {
            }

            column(OurPurchaseOrderLbl; StrSubstNo('%1:', OurPurchaseOrderLbl))
            {

            }

            Column(OurPurchaseOrder; "Order No.")
            {


            }

            column(OurDeliveryBill_Lbl; StrSubstNo('%1:', OurDeliveryBillLbl))
            {
            ...
            column(DeliveryDate_Lbl; StrSubstNo('%1:', DeliveryDateLbl))
            {

            }
            column(DeliveryDate; format(RecGTempSalesShptline."posting date", 0))
            {

            }

            column(OurMail_Lbl; StrSubstNo('%1:', OurMailLbl))
            {
            ...
            dataitem(Line; "Sales Invoice Line")
            {
                ...
                column(Description_WithComplement; TxtGDescription_WithComplement)
                {
                }
                ...
                column(Description_Line_Lbl; DescCaptionLbl)
                {
                }
                ...
                column(TotalPrice_Lbl; TotalPriceCaptionLbl)
                {
                }
                column(LineAmount_Line_Lbl; TotalPriceCaptionLbl)
                {
                }
                column(ItemNo_Line; "No.")
                {
                }
                column(ItemNo_Line_Lbl; ItemNoCaptionLbl)
                {
                }
                ...
                column(Quantity_Line_Lbl; qtycaptionlbl)
                {
                }
                column(Type_Line; Format(Type))
                {
                }
                column(UnitPrice; TxtGUnitPrice)
                {
                    AutoFormatExpression = GetCurrencyCode;
                    AutoFormatType = 2;
                }
                ...
                begin
                    ...
                    TxtGUnitPrice := BlankZeroWithCurrencyCode("Unit Price");
                    ...
                    if RecGItem.Get("No.") then begin
                        ...
                        if RecGCountryRegion.Get(RecGItem."Country/Region of Origin Code") AND (RecGCountryRegion.Name <> '') then
                            TxTGCountryOfOrigin := StrSubstNo('%1 %2', CountryOfOriginLabel, RecGCountryRegion.Name)
                    end;

                    GetExtendedDescription(Line, TxtGDescription_WithComplement, TxtGComplementDescritpion);

                    /*if Type = Type::"G/L Account" then begin
                        if RecGGeneralPostingSetup.Get("Gen. Bus. Posting Group", "Gen. Prod. Posting Group") then
                            if "No." = RecGGeneralPostingSetup."Sales Prepayments Account" then begin
                                TxtGLineAmount := BlankZeroWithCurrencyCode(-"Line Amount");
                                TxtGUnitPrice := BlankZeroWithCurrencyCode(-"Unit Price");
                            end;
                    end;*/
                    if "DBE Job Schedule Line No." <> 0 then
                        Quantity := 1;
            ...
            {
                DataItemTableView = SORTING(Number) WHERE(Number = CONST(1));
                column(TotalNetAmount; TxtGTotalAmount)
                {
                    AutoFormatExpression = Header."Currency Code";
                    AutoFormatType = 1;
                }
                ...
                column(TotalAmountIncludingVAT; StrSubstNo('%1 %2', CurrencyCode, Format(TotalAmountInclVAT, 0, '<Integer Thousand><Decimals,3>')))
                {
                    AutoFormatExpression = Header."Currency Code";
                    AutoFormatType = 1;
                }
                ...
                column(VAT; StrSubstNo('%1%', DecGVAt))
                {
                }
                ...
                trigger OnAfterGetRecord()
                begin
                    TxtGVATAmount := BlankZeroWithCurrencyCode(TotalAmountVAT);
                    TxTGTotalAmount := BlankZeroWithCurrencyCode(TotalAmount);
                    //TxtGTotalAmountInclVAT := BlankZeroWithCurrencyCode(TotalAmountInclVAT);
                end;
            ...
            var
                ...
                RecLSalesInvoiceHeaderTmp: Record "Sales Invoice Header" temporary;
            ...
            begin
                ...
                //DBE
                RecLSalesInvoiceHeaderTmp.init;
                RecLSalesInvoiceHeaderTmp.TransferFields(Header);
                IF RecLSalesInvoiceHeaderTmp."Bill-to Name 2" <> '' then begin
                    RecLSalesInvoiceHeaderTmp."Bill-to name" := RecLSalesInvoiceHeaderTmp."Bill-to name 2";
                    RecLSalesInvoiceHeaderTmp."Bill-to name 2" := '';
                end;
                FormatAddressFields(RecLSalesInvoiceHeaderTmp);

                IF Not RecGCountryRegion.GET(CompanyInfo."Country/Region Code") then
                ...
                RecGTempSalesShptLine.deleteall;
                RecLSalesInvoiceLine.SetRange("Document No.", "No.");
                RecLSalesInvoiceLine.setrange(Type, RecLSalesInvoiceLine.type::Item);
                IF RecLSalesInvoiceLine.FindSet() THEN
                    RecLSalesInvoiceLine.GetSalesShptLines(RecGTempSalesShptLine);
                IF Not RecGTempSalesShptLine.FindFirst() THEN
                    RecGTempSalesShptLine.init;
                IF Not RecGSalesShptHeader.GET(RecGTempSalesShptLine."Document No.") then
                    RecGSalesShptHeader.init;

                SearchBankAccount(Header);

                PostedApprovalEntry.SetRange("Table ID", 110);
                ...
                if not RecGCustomer.Get("Sell-to Customer No.") then RecGCustomer.Init();
        ...
        /*dataitem(ExtendedTextLine; "Extended Text Line")
        {
            ...
            var
                ...
                RecLExtendedTextHeader: Record "Extended Text Header";
                RecLCustomer: Record Customer;
            begin
                if not RecLCustomer.Get(Header."Sell-to Customer No.") then
                    CurrReport.Break();

                if not RecLStandardText.Get(RecLCustomer."BBX Standard Text Code") then
                    CurrReport.Break();

                RecLExtendedTextHeader.SetRange("Table Name", RecLExtendedTextHeader."Table Name"::"Standard Text");
                RecLExtendedTextHeader.SetRange("No.", RecLStandardText.Code);
                If RecLExtendedTextHeader.FindFirst() then begin
                    SetRange("Table Name", RecLExtendedTextHeader."Table Name");
                    SetRange("No.", RecLExtendedTextHeader."No.");
                end else
                    CurrReport.Break();
            end;
        }*/
        dataitem(ExtendedTextLine; "Extended Text Line")
        {
            ...
            begin
                ...
                RecGCountryRegion.Reset();
                if RecGCountryRegion.Get(Header."Sell-to Country/Region Code") then
                    if not RecGCountryRegion."BBX CH PREF ORIGIN" then
                        CurrReport.Break();
    ...
    var
        ...
        QuoteNOCaptionLbl: Label 'Our quotation';
        YourRegistrationCaptionLbl: Label 'Your VAT No.';
        YourReferenceCaptionLbl: label 'You purchase order';
        YourContactReferenceCaptionLbl: Label 'Your reference';
        OurReferenceCaptionLbl: Label 'Our reference';
        InvoiceoAddrLbl: Label 'Invoicing address :';
        DocumentDateLbl: Label 'Date';
        OrderDateLbl: label 'Date of order';
        DeliveryDateLbl: label 'Delivery date';
        OurDeliveryBillLbl: label 'Our delivery bill';
        OurMailLbl: label 'Our mail';
        OurPurchaseOrderLbl: label 'Our confirmation order';
        PaymentLbl: Label 'Payment must be done net of any bank charge & commission (code SEPA "OUR")';
        ...
        RecGSalesShptHeader: Record "Sales Shipment Header";
        ...
        RecGGeneralPostingSetup: Record "General Posting Setup";
        TxtGDescription_WithComplement: Text;
        TxtGComplementDescritpion: Text;
    ...
    local procedure SearchBankAccount(RecPSalesInvHeader: record "Sales Invoice Header")
    begin
        RecGBankAccount.RESET;
        RecGBankAccount.SETRANGE(BBXBankShowInvoiceFooter, true);
        RecGBankAccount.SETfilter("Currency Code", '%1', RecPSalesInvHeader."Currency Code");
    ...
    procedure GetExtendedDescription(RecPSalesInvoiceLine: Record "Sales Invoice Line"; var TxtPDescription_WithComplement: Text; var TxtPComplementDescritpion: Text)
    var
        RecLSalesInvoiceLine: Record "Sales Invoice Line";
        CduLTypeHelper: Codeunit "Type Helper";
        BooLStop: Boolean;
        BooLFirstLine: Boolean;
    begin
        Clear(TxtPDescription_WithComplement);
        BooLStop := false;
        BooLFirstLine := true;
        RecLSalesInvoiceLine.SetRange("Document No.", RecPSalesInvoiceLine."Document No.");
        RecLSalesInvoiceLine.Setfilter("Line No.", '%1..', RecPSalesInvoiceLine."Line No.");
        if RecLSalesInvoiceLine.FindSet() then begin
            BooLStop := RecLSalesInvoiceLine.Next() = 0;
            while (BooLStop = false) do begin
                if RecLSalesInvoiceLine.Type <> RecLSalesInvoiceLine.type::" " then
                    BooLStop := true;
                ...
                if BooLFirstLine then
                    ...
                    if TxtPDescription_WithComplement = '' then
                        TxtPDescription_WithComplement += RecLSalesInvoiceLine.Description
                    else
                        TxtPDescription_WithComplement += CduLTypeHelper.NewLine() + RecLSalesInvoiceLine.Description; //+ RecLSalesInvoiceLine.Description;

                /*if TxtPComplementDescritpion = '' then
                    TxtPComplementDescritpion := RecLSalesInvoiceLine.Description
                else
                    TxtPComplementDescritpion += ' ' + RecLSalesInvoiceLine.Description;//CduLTypeHelper.NewLine() + RecLSalesInvoiceLine.Description;*/
