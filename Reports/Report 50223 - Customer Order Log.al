report 50223 "BBX Order Log"
{
    DefaultLayout = RDLC;
    RDLCLayout = './BlueBotics Customer Order Log.rdl';
    ApplicationArea = Basic, Suite;
    Caption = 'BlueBotics Order Log';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            dataitem("Sales Line"; "Sales Line")
            {
                ...
                begin
                    CalcFields("BBX Expected Delivery Date");
                    PeriodNo := 1;
                    //while "Shipment Date" >= PeriodStartDate[PeriodNo] do
                    while "BBX Expected Delivery Date" >= PeriodStartDate[PeriodNo] do
                        PeriodNo := PeriodNo + 1;
