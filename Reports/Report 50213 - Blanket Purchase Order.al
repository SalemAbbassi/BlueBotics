report 50213 "BBC Blanket Purchase Order"
{
    WordLayout = './BlueBotics Blanket Purchase Order.docx';
    Caption = 'BlueBotics Blanket Purchase Order';
    DefaultLayout = Word;
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(BlanketPurchOrderNo; GetBlanketOrderNo("Purchase Header"))
            {
            }
            ...
            column(DeliveryDate; FORMAT("Promised Receipt Date", 0, 4))
            {
            }
            ...
            dataitem("Purchase Line"; "Purchase Line")
            {
                ...
                Column(Cross_Reference_No_PurchLine; "Cross-Reference No.")
                {
    ...
    var
        CurrencyCode: Text;
        DocumentTitleLbl: Label 'BLANKET PURCHASE ORDER';
        QuotationCaptionLbl: Label 'Quotation';
        DateOfQuotationLbl: Label 'Quotation:';
    ...
    local procedure GetBlanketOrderNo(RecPPurchaseHeader: Record "Purchase Header"): Code[20]
    var
        RecLPurchaseLine: Record "Purchase Line";
    begin
        RecLPurchaseLine.SetRange("Document Type", RecPPurchaseHeader."Document Type");
        RecLPurchaseLine.SetRange("Document No.", RecPPurchaseHeader."No.");
        if RecLPurchaseLine.FindSet() then
            repeat
                if RecLPurchaseLine."Blanket Order No." <> '' then
                    exit(RecLPurchaseLine."Blanket Order No.")
