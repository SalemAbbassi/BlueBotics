report 50222 "BBX Reminder"
{
    DefaultLayout = RDLC;
    RDLCLayout = './BlueBotics - Reminder.rdl';
    Caption = 'BlueBotics - Reminder';
    ...
    dataset
    {
        dataitem("Issued Reminder Header"; "Issued Reminder Header")
        {
            ...
            column(CompanyPicture; RecGCompanyInfo.Picture)
            {
            }
            column(No_IssuedReminderHeader; "No.")
            {
            }
            column(ExternalDocNoCaption; RecGCustLedgerEntry.FieldCaption("External Document No."))
            {
            }
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                dataitem("Issued Reminder Line"; "Issued Reminder Line")
                {
                    ...
                    column(ExtenalDoNo_IssuedReminderLine; GetExternalDocNo("Issued Reminder Line"))
                    {
                    }
            ...
            begin
                ...
                SearchBankAccount("Issued Reminder Header");
            end;
    ...
    var
        ...
        RecGCustLedgerEntry: Record "Cust. Ledger Entry";
    ...
    local procedure SearchBankAccount(RecPIssuedReminderHeader: Record "Issued Reminder Header")
    begin
        RecGBankAccount.RESET;
        RecGBankAccount.SETRANGE(BBXBankShowInvoiceFooter, true);
        RecGBankAccount.SETfilter("Currency Code", '%1', RecPIssuedReminderHeader."Currency Code");
    ...
    local procedure GetExternalDocNo(RecPIssuedReminderLine: Record "Issued Reminder Line") CodPRExternalDocNo: Code[35]
    begin
        if not (RecPIssuedReminderLine.Type = RecPIssuedReminderLine.Type::" ") then Begin
            RecGCustLedgerEntry.SetRange("Document Type", RecPIssuedReminderLine."Document Type");
            RecGCustLedgerEntry.SetRange("Document No.", RecPIssuedReminderLine."Document No.");
            if RecGCustLedgerEntry.FindFirst() then
                CodPRExternalDocNo := RecGCustLedgerEntry."External Document No.";
        End;
    end;
}
