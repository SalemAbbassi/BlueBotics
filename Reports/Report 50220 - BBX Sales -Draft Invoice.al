report 50220 "Sales - Draft Invoice"
{
    WordLayout = './BlueBotics Sales Draft Invoice.docx';
    Caption = 'BlueBotics - Draft Invoice';
    DefaultLayout = Word;
    ...
    local procedure SearchBankAccount(RecPSalesHeader: record "Sales Header")
    begin
        RecGBankAccount.RESET;
        RecGBankAccount.SETRANGE(BBXBankShowInvoiceFooter, true);
        RecGBankAccount.SETfilter("Currency Code", '%1', RecPSalesHeader."Currency Code");
