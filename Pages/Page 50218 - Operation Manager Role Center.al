page 50218 "BBX Operat Manager Role Center"
{
    Caption = 'Operation Manager', Comment = '{Dependency=Match,"ProfileDescription_SMALLBUSINESS"}';
    PageType = RoleCenter;
    ...
    layout
    {
        area(rolecenter)
        {
            ...
            part(Control1; "BBX Manager O365 Activities")
            {
                AccessByPermission = TableData "Activities Cue" = I;
                ApplicationArea = Basic, Suite;
            }
            part(control11; "BBX Manager Purchase Activ.")
            {
                ApplicationArea = Basic, Suite;
                Caption = '';
            }
            part(Control2; "CDC Doc. Capture Activities")
            {
                ApplicationArea = Basic, Suite;
                Caption = '';
            }
            ...
            part(Control3; "CEM Activities")
            {
                ApplicationArea = Basic, Suite;
                Caption = '';
            }
            part(control4; "Team Member Activities No Msgs")
            {
                ApplicationArea = Basic, Suite;
                Caption = '';
            }
            part(Control5; "BBX Accountant Activities")
            {
                ApplicationArea = Basic, Suite;
                Caption = '';
            }
            part(Control6; "Service Dispatcher Activities")
            {
                ApplicationArea = Basic, Suite;
                Caption = '';
            }
            part(Control7; "BBX Manager SO Process. Activ.")
            {
                ApplicationArea = Basic, Suite;
                Caption = '';
            }
            part(Control8; "Production Planner Activities")
            {
                ApplicationArea = Basic, Suite;
                Caption = '';
            }
            part(Control9; "Sales & Relationship Mgr. Act.")
            {
                ApplicationArea = Basic, Suite;
                Caption = '';
            }
            part(Control10; "Whse Ship & Receive Activities")
            {
                ApplicationArea = Basic, Suite;
                Caption = '';
            }
            part(Control12; "BBX Billing Schedules Activ.")
            {
                ApplicationArea = Basic, Suite;
                Caption = '';
            }
